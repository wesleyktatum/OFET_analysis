...
class Window(wx.Frame):
    ...
    def __init__(self, **kwargs):
        ...
        # the results section for calculated values
        ...
        Window.calc_values = []
        Window.save_file_name = 'OFET_data.csv'
    ...
    def onSave(self, event):
        ...
        exist_flag = os.path.exists(Window.save_file_name)
        with open(Window.save_file_name, 'a+') as output_file:
            if not exist_flag:
    ...
    def onAverage(self, event):
        ...
        with open(Window.save_file_name) as output_file:
...
class InputDialog(wx.Panel):
    def __init__(self, parent, parameters):
        ...
        self.InputTitle = wx.StaticText(self, wx.ID_ANY, pos=(25, 20),
        ...
        self.Type = wx.ComboBox(self,
                                ...
                                pos=(20, 270), size=(130, -1))
        # for file name for saved data
        self.file_name = wx.StaticText(self, wx.ID_ANY,
                                       label='Save File As:', pos=(20, 380))
        self.save_file = wx.TextCtrl(self, value=self.save_file_name,
                                     pos=(20, 400), size=(150, -1))

        # creating and linking Save and Reset buttons
        self.saveButton = wx.Button(self, wx.ID_ANY, label="Save Parameters",
                                    pos=(55, 300))
        self.btnSaveFile = wx.Button(self, -1, "Save Filename",
                                     pos=(55, 430))

        self.saveButton.Bind(wx.EVT_BUTTON, self.SaveConnString)
        self.btnSaveFile.Bind(wx.EVT_BUTTON, self.saveFileName)
        self.Show()
    ...
    # save file name
    def saveFileName(self, event):
        file_name = self.save_file.GetValue()

        Window.save_file_name = file_name
